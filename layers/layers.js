...
var format_Public_Woodland_Amannsover100_6 = new ol.format.GeoJSON();
var features_Public_Woodland_Amannsover100_6 = format_Public_Woodland_Amannsover100_6.readFeatures(json_Public_Woodland_Amannsover100_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Public_Woodland_Amannsover100_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Public_Woodland_Amannsover100_6.addFeatures(features_Public_Woodland_Amannsover100_6);
var lyr_Public_Woodland_Amannsover100_6 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Public_Woodland_Amannsover100_6, 
                style: style_Public_Woodland_Amannsover100_6,
                popuplayertitle: "Public_Woodland_Amannsover100",
                interactive: false,
                title: '<img src="styles/legend/Public_Woodland_Amannsover100_6.png" /> Public_Woodland_Amannsover100'
            });
...
var format_Public_SWRA_Key_Sites_9 = new ol.format.GeoJSON();
var features_Public_SWRA_Key_Sites_9 = format_Public_SWRA_Key_Sites_9.readFeatures(json_Public_SWRA_Key_Sites_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Public_SWRA_Key_Sites_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Public_SWRA_Key_Sites_9.addFeatures(features_Public_SWRA_Key_Sites_9);
var lyr_Public_SWRA_Key_Sites_9 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Public_SWRA_Key_Sites_9, 
                style: style_Public_SWRA_Key_Sites_9,
                popuplayertitle: "Public_SWRA_Key_Sites",
                interactive: true,
                title: '<img src="styles/legend/Public_SWRA_Key_Sites_9.png" /> Public_SWRA_Key_Sites'
            });
var format_SWDistrictRegions_10 = new ol.format.GeoJSON();
var features_SWDistrictRegions_10 = format_SWDistrictRegions_10.readFeatures(json_SWDistrictRegions_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SWDistrictRegions_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SWDistrictRegions_10.addFeatures(features_SWDistrictRegions_10);
var lyr_SWDistrictRegions_10 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_SWDistrictRegions_10, 
                style: style_SWDistrictRegions_10,
                popuplayertitle: "SW District Regions",
                interactive: false,
                title: '<img src="styles/legend/SWDistrictRegions_10.png" /> SW District Regions'
            });
var format_DemoPoints3_11 = new ol.format.GeoJSON();
var features_DemoPoints3_11 = format_DemoPoints3_11.readFeatures(json_DemoPoints3_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_DemoPoints3_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_DemoPoints3_11.addFeatures(features_DemoPoints3_11);
var lyr_DemoPoints3_11 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_DemoPoints3_11, 
                style: style_DemoPoints3_11,
                popuplayertitle: "DemoPoints3",
                interactive: true,
                title: '<img src="styles/legend/DemoPoints3_11.png" /> DemoPoints3'
            });
var group_2testgroup = new ol.layer.Group({
                                layers: [lyr_Public_Amanns_Index_0,lyr_Public_Hexbins_JustAmannsAvg_1,],
                                title: "2 test group"});

lyr_Public_Amanns_Index_0.setVisible(false);lyr_Public_Hexbins_JustAmannsAvg_1.setVisible(false);lyr_GoogleTerrain_2.setVisible(true);lyr_ESRIShadedRelief_3.setVisible(true);lyr_WFD_River_Water_Bodies_Cycle_3_4.setVisible(true);lyr_Hygrothermy_5.setVisible(true);lyr_Public_Woodland_Amannsover100_6.setVisible(true);lyr_Public_Coresites_Layer_7.setVisible(true);lyr_Public_SWRA_Key_Sitescopy_8.setVisible(true);lyr_Public_SWRA_Key_Sites_9.setVisible(true);lyr_SWDistrictRegions_10.setVisible(true);lyr_DemoPoints3_11.setVisible(true);
var layersList = [group_2testgroup,lyr_GoogleTerrain_2,lyr_ESRIShadedRelief_3,lyr_WFD_River_Water_Bodies_Cycle_3_4,lyr_Hygrothermy_5,lyr_Public_Woodland_Amannsover100_6,lyr_Public_Coresites_Layer_7,lyr_Public_SWRA_Key_Sitescopy_8,lyr_Public_SWRA_Key_Sites_9,lyr_SWDistrictRegions_10,lyr_DemoPoints3_11];
...
lyr_Public_Woodland_Amannsover100_6.set('fieldAliases', {'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
...
lyr_Public_SWRA_Key_Sites_9.set('fieldAliases', {'Site': 'Site', 'latitude': 'latitude', 'longitude': 'longitude', 'Site info': 'Site info', 'Image': 'Image', });
lyr_SWDistrictRegions_10.set('fieldAliases', {'year': 'year', 'ctry_code': 'ctry_code', 'ctry_name': 'ctry_name', 'rgn_code': 'rgn_code', 'rgn_name': 'rgn_name', 'ctyua_code': 'ctyua_code', 'ctyua_name': 'ctyua_name', 'ctyua_area_': 'ctyua_area_', 'ctyua_type': 'ctyua_type', });
lyr_DemoPoints3_11.set('fieldAliases', {'fid': 'fid', 'x': 'x', 'y': 'y', 'whatAmI': 'whatAmI', 'describe': 'describe', 'image': 'image', });
...
lyr_Public_Woodland_Amannsover100_6.set('fieldImages', {'Shape_Leng': '', 'Shape_Area': '', });
...
lyr_Public_SWRA_Key_Sites_9.set('fieldImages', {'Site': '', 'latitude': '', 'longitude': '', 'Site info': '', 'Image': '', });
lyr_SWDistrictRegions_10.set('fieldImages', {'year': 'TextEdit', 'ctry_code': 'TextEdit', 'ctry_name': 'TextEdit', 'rgn_code': 'TextEdit', 'rgn_name': 'TextEdit', 'ctyua_code': 'TextEdit', 'ctyua_name': 'TextEdit', 'ctyua_area_': 'TextEdit', 'ctyua_type': 'TextEdit', });
lyr_DemoPoints3_11.set('fieldImages', {'fid': 'TextEdit', 'x': 'Range', 'y': 'DateTime', 'whatAmI': 'TextEdit', 'describe': 'TextEdit', 'image': 'ExternalResource', });
...
lyr_Public_Woodland_Amannsover100_6.set('fieldLabels', {'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
lyr_Public_Coresites_Layer_7.set('fieldLabels', {'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
lyr_Public_SWRA_Key_Sitescopy_8.set('fieldLabels', {'Site': 'header label - always visible', 'latitude': 'hidden field', 'longitude': 'hidden field', 'Site info': 'header label - always visible', 'Image': 'no label', });
lyr_Public_SWRA_Key_Sites_9.set('fieldLabels', {'Site': 'no label', 'latitude': 'no label', 'longitude': 'no label', 'Site info': 'no label', 'Image': 'no label', });
lyr_SWDistrictRegions_10.set('fieldLabels', {'year': 'no label', 'ctry_code': 'no label', 'ctry_name': 'no label', 'rgn_code': 'no label', 'rgn_name': 'no label', 'ctyua_code': 'no label', 'ctyua_name': 'no label', 'ctyua_area_': 'no label', 'ctyua_type': 'no label', });
lyr_DemoPoints3_11.set('fieldLabels', {'fid': 'inline label - always visible', 'x': 'no label', 'y': 'no label', 'whatAmI': 'header label - visible with data', 'describe': 'inline label - always visible', 'image': 'no label', });
lyr_DemoPoints3_11.on('precompose', function(evt) {
