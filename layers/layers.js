...
var format_SWDistrictRegions_6 = new ol.format.GeoJSON();
var features_SWDistrictRegions_6 = format_SWDistrictRegions_6.readFeatures(json_SWDistrictRegions_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SWDistrictRegions_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SWDistrictRegions_6.addFeatures(features_SWDistrictRegions_6);
var lyr_SWDistrictRegions_6 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_SWDistrictRegions_6, 
                style: style_SWDistrictRegions_6,
                popuplayertitle: "SW District Regions",
                interactive: false,
                title: '<img src="styles/legend/SWDistrictRegions_6.png" /> SW District Regions'
            });
var format_Public_Woodland_Layer_7 = new ol.format.GeoJSON();
var features_Public_Woodland_Layer_7 = format_Public_Woodland_Layer_7.readFeatures(json_Public_Woodland_Layer_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Public_Woodland_Layer_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Public_Woodland_Layer_7.addFeatures(features_Public_Woodland_Layer_7);
var lyr_Public_Woodland_Layer_7 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Public_Woodland_Layer_7, 
                style: style_Public_Woodland_Layer_7,
                popuplayertitle: "Public_Woodland_Layer",
                interactive: false,
                title: '<img src="styles/legend/Public_Woodland_Layer_7.png" /> Public_Woodland_Layer'
            });
var format_Public_Coresites_Layer_8 = new ol.format.GeoJSON();
var features_Public_Coresites_Layer_8 = format_Public_Coresites_Layer_8.readFeatures(json_Public_Coresites_Layer_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Public_Coresites_Layer_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Public_Coresites_Layer_8.addFeatures(features_Public_Coresites_Layer_8);
var lyr_Public_Coresites_Layer_8 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Public_Coresites_Layer_8, 
                style: style_Public_Coresites_Layer_8,
                popuplayertitle: "Public_Coresites_Layer",
                interactive: false,
                title: '<img src="styles/legend/Public_Coresites_Layer_8.png" /> Public_Coresites_Layer'
            });
var format_Public_SWRA_Key_Sitescopy_9 = new ol.format.GeoJSON();
var features_Public_SWRA_Key_Sitescopy_9 = format_Public_SWRA_Key_Sitescopy_9.readFeatures(json_Public_SWRA_Key_Sitescopy_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Public_SWRA_Key_Sitescopy_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Public_SWRA_Key_Sitescopy_9.addFeatures(features_Public_SWRA_Key_Sitescopy_9);
var lyr_Public_SWRA_Key_Sitescopy_9 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Public_SWRA_Key_Sitescopy_9, 
                style: style_Public_SWRA_Key_Sitescopy_9,
                popuplayertitle: "Public_SWRA_Key_Sites copy",
                interactive: true,
                title: '<img src="styles/legend/Public_SWRA_Key_Sitescopy_9.png" /> Public_SWRA_Key_Sites copy'
            });
...
lyr_Public_Amanns_Index_0.setVisible(true);lyr_Public_Hexbins_JustAmannsAvg_1.setVisible(true);lyr_GoogleTerrain_2.setVisible(true);lyr_ESRIShadedRelief_3.setVisible(true);lyr_WFD_River_Water_Bodies_Cycle_3_4.setVisible(true);lyr_Hygrothermy_5.setVisible(true);lyr_SWDistrictRegions_6.setVisible(true);lyr_Public_Woodland_Layer_7.setVisible(true);lyr_Public_Coresites_Layer_8.setVisible(true);lyr_Public_SWRA_Key_Sitescopy_9.setVisible(true);lyr_DemoPoints3_10.setVisible(true);
var layersList = [group_2testgroup,lyr_GoogleTerrain_2,lyr_ESRIShadedRelief_3,lyr_WFD_River_Water_Bodies_Cycle_3_4,lyr_Hygrothermy_5,lyr_SWDistrictRegions_6,lyr_Public_Woodland_Layer_7,lyr_Public_Coresites_Layer_8,lyr_Public_SWRA_Key_Sitescopy_9,lyr_DemoPoints3_10];
...
lyr_SWDistrictRegions_6.set('fieldAliases', {'year': 'year', 'ctry_code': 'ctry_code', 'ctry_name': 'ctry_name', 'rgn_code': 'rgn_code', 'rgn_name': 'rgn_name', 'ctyua_code': 'ctyua_code', 'ctyua_name': 'ctyua_name', 'ctyua_area_': 'ctyua_area_', 'ctyua_type': 'ctyua_type', });
lyr_Public_Woodland_Layer_7.set('fieldAliases', {'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', 'VxCount': 'VxCount', });
lyr_Public_Coresites_Layer_8.set('fieldAliases', {'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_Public_SWRA_Key_Sitescopy_9.set('fieldAliases', {'Site': 'Site', 'latitude': 'latitude', 'longitude': 'longitude', 'Site info': 'Site info', 'Image': 'Image', });
...
lyr_SWDistrictRegions_6.set('fieldImages', {'year': 'TextEdit', 'ctry_code': 'TextEdit', 'ctry_name': 'TextEdit', 'rgn_code': 'TextEdit', 'rgn_name': 'TextEdit', 'ctyua_code': 'TextEdit', 'ctyua_name': 'TextEdit', 'ctyua_area_': 'TextEdit', 'ctyua_type': 'TextEdit', });
lyr_Public_Woodland_Layer_7.set('fieldImages', {'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', 'VxCount': 'TextEdit', });
lyr_Public_Coresites_Layer_8.set('fieldImages', {'Shape_Leng': '', 'Shape_Area': '', });
lyr_Public_SWRA_Key_Sitescopy_9.set('fieldImages', {'Site': 'TextEdit', 'latitude': 'TextEdit', 'longitude': 'TextEdit', 'Site info': 'TextEdit', 'Image': 'ExternalResource', });
...
lyr_SWDistrictRegions_6.set('fieldLabels', {'year': 'no label', 'ctry_code': 'no label', 'ctry_name': 'no label', 'rgn_code': 'no label', 'rgn_name': 'no label', 'ctyua_code': 'no label', 'ctyua_name': 'no label', 'ctyua_area_': 'no label', 'ctyua_type': 'no label', });
lyr_Public_Woodland_Layer_7.set('fieldLabels', {'Shape_Leng': 'no label', 'Shape_Area': 'no label', 'VxCount': 'no label', });
lyr_Public_Coresites_Layer_8.set('fieldLabels', {'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
lyr_Public_SWRA_Key_Sitescopy_9.set('fieldLabels', {'Site': 'header label - always visible', 'latitude': 'hidden field', 'longitude': 'hidden field', 'Site info': 'header label - always visible', 'Image': 'no label', });
